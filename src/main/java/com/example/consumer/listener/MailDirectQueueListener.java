...
import com.example.consumer.service.MailSendingService;
...
//        mailObjectMap.forEach((k,v)->{
//            System.out.println(String.format("key: %s , value: %s",k,v));
//        });
        System.out.println(mailSendingMqDTO.toString());
        System.out.println(messageProperties.toString());
        System.out.println(__TypeId__);
